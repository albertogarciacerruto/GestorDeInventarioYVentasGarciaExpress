				...
				@csrf
                    <div class="login-form-head">
                        <a href="{{ url('/') }}">
                            ...
                            <h4 style="margin-top:10px">Gestor de Inventario</h4>
						</a>
                    </div>
                    <div class="login-form-body">
                        <div class="form-gp">
                            ...
                            <i class="ti-email"></i>
                            <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" autocomplete="off" required>
							@if ($errors->has('email'))
