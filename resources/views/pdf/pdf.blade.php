        ...
        <tbody>
          ...
          @if($count > 0)
            ...
            <tr class="row15">
              ...
              <td class="column7 style42 n style44" colspan="3">{{  number_format($product->amount,2) }}</td>
            </tr>
            @endforeach
          @endif
          ...
          @if($conta > 0)
            ...
            <tr class="row18">
              ...
              <td class="column7 style42 n style44" colspan="3">{{  number_format($servicio->amount,2) }}</td>
            </tr>
            @endforeach
          @endif
          <tr class="row19">
            ...
            <td class="column7 style4 n style6" colspan="3">$ {{ number_format($quotation->iva,2) }}</td>
          </tr>
          <tr class="row20">
            <td class="column0 style3 null"></td>
            <td class="column1 style3 null"></td>
            ...
            <td class="column7 style20 n style22" colspan="3">$ {{ number_format($quotation->total,2) }}</td>
          </tr>
          <tr class="row21">
