    ...
    <table size="2" style="width: 100%; margin: 0 auto; position: absolute;" border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines">
        ...
        <tbody>
          ...
          <tr class="row15">
            ...
            <td class="column7 style42 n style44" colspan="3">Bs. {{  number_format($payment->amount,2) }}</td>
          </tr>
          @endforeach
          ...
          <tr class="row19">
            ...
            <td class="column7 style4 n style6" colspan="3">$ {{ number_format($order->iva,2) }}</td>
          </tr>
          <tr class="row20">
            <td class="column0 style3 null"></td>
            <td class="column1 style3 null"></td>
            ...
            <td class="column7 style20 n style22" colspan="3">$ {{ number_format($order->total,2)}}</td>
          </tr>
          <tr class="row21">
