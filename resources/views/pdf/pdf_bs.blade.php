...
body { margin-left: 10px; margin-right: 10px; margin-top: 10px; margin-bottom: 10px; }
    ...
    <table size="2" style="width: 100%; margin: 0 auto; position: absolute;" border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines">
        ...
        <tbody>
          ...
          <tr class="row1">
            <td class="column0 style8 s style8" colspan="10">Cotizacion </td>
          </tr>
          <tr class="row2">
            <td class="column0 style9 s style9" colspan="2">Fecha solicitud:</td>
            <td class="column2 style2 n style2" colspan="8">{{$quotation->date_init}}</td>
          </tr>
          <tr class="row3">
            <td class="column0 style9 s style9" colspan="2">Fecha vencimiento: </td>
            <td class="column2 style2 s style2" colspan="8">{{$quotation->date_finish}}</td>
          </tr>
          <tr class="row4">
            <td class="column0 style9 s style9" colspan="2"># Cotización:</td>
            <td class="column2 style2 n style2" colspan="8">{{$quotation->id}}</td>
          </tr>
          <tr class="row5">
          ...
          @if($count > 0)
            <tr class="row13">
              <td class="column0 style23 s style25" colspan="10">Repuestos cotizados</td>
            </tr>
            <tr class="row14">
            ...
            <tr class="row15">
              ...
              <td class="column7 style42 n style44" colspan="3">{{  number_format(($product->amount*$quotation->dolar_value),2) }}</td>
            </tr>
            @endforeach
          @endif
          ...
          @if($conta > 0)
            <tr class="row16">
              <td class="column0 style29 s style31" colspan="10">Servicios cotizados</td>
            </tr>
            <tr class="row17">
            ...
            <tr class="row18">
              ...
              <td class="column7 style42 n style44" colspan="3">{{  number_format(($servicio->amount*$quotation->dolar_value),2) }}</td>
            </tr>
            @endforeach
          @endif
          <tr class="row19">
            ...
            <td class="column7 style4 n style6" colspan="3">Bs. {{ number_format(($quotation->iva*$quotation->dolar_value),2) }}</td>
          </tr>
          <tr class="row20">
            <td class="column0 style3 null"></td>
            <td class="column1 style3 null"></td>
            ...
            <td class="column7 style20 n style22" colspan="3">Bs. {{ number_format(($quotation->total*$quotation->dolar_value),2) }}</td>
          </tr>
          <tr class="row21">
            <td class="column0 style23 s style25" colspan="10">Esta cotizacion solo es valida por 24 Horas a partir de la fecha de solictud, teniendo termino de   </td>
          </tr>
          <tr class="row22">
            <td class="column0 style26 s style28" colspan="10">vigencia la fecha de vencimiento especificada en la parte superior </td>
          </tr>
        </tbody>
    </table>
  </body>
